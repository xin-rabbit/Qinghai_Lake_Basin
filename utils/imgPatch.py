# des: remote sensing image to multi-scale patches,

import numpy as np

class imgPatch():
    '''
    des: 1. remote sensing image to multi-scale patches
    ...
    def higher_patch_crop(self, higher_patch_size, start_list):
        '''
        des: crop the higher-scale patch using the given low-scale patch)
        input:
